...
def sample_nested_lm(y: List[LmSuffStat], ik: List[np.ndarray], iik: List[List[np.ndarray]], 
                     mu0: np.ndarray, tau0: np.ndarray, 
                     tau: List[np.ndarray], lam: np.ndarray, ome: np.random.Generator) -> List[np.ndarray]:
...
def prop_forw(f2v0: List[F2V], iik: List[List[np.ndarray]], tau0: np.ndarray, tau: List[np.ndarray]
              ) -> List[List[V2F]]:
...
def prop_v2f(f2v: List[F2V], iik: List[np.ndarray], tau: np.ndarray) -> List[V2F]:
...
def sample_backw(v2f: List[List[V2F]], ik: List[np.ndarray], mu0: np.ndarray, tau0: np.ndarray, tau: List[np.ndarray], 
